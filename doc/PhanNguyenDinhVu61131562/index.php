...
<head>
    ...
    <title>PhanNguyenDinhVu61131562</title>
</head>
<body>
    <?php
        $severname="localhost";
    ...
    <form method="post" action="">
        <table align="center" bgcolor="purple">
            <tr>
                <td colspan="2" align="center"><h1>Nhập thông tin sinh viên</h1></td>
            </tr>
            <tr>
                <td>Tên</td>
            ...
            <tr>
                ...
                <td>
                    <select name="malop">
                        <option value="1">61-cntt1</option>
                        <option value="2">61-cntt2</option>
                    </select>
                </td>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="submit" name="ketqua" value="Xem Kết Quả">
                </td>
            </tr>
            <tr>
